...
echo 'Starting wget'
sudo wget https://repo1.maven.org/maven2/org/openapitools/openapi-generator-cli/7.8.0/openapi-generator-cli-7.8.0.jar -O /usr/local/bin/openapi-generator-cli.jar || { echo 'wget failed'; exit 1; }
