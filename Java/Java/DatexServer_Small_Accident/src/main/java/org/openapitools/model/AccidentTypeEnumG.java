...
public class AccidentTypeEnumG {

  private AccidentTypeEnum value;

  private String extendedValueG;

  public AccidentTypeEnumG() {
    super();
  }
   ...
   */
  public AccidentTypeEnumG(AccidentTypeEnum value) {
    this.value = value;
  }

  public AccidentTypeEnumG value(AccidentTypeEnum value) {
    this.value = value;
    return this;
  }
  ...
  public AccidentTypeEnumG extendedValueG(String extendedValueG) {
  ...
  public boolean equals(Object o) {
    ...
    AccidentTypeEnumG accidentTypeEnumG = (AccidentTypeEnumG) o;
    return Objects.equals(this.value, accidentTypeEnumG.value) &&
        Objects.equals(this.extendedValueG, accidentTypeEnumG.extendedValueG);
  }
  ...
  public String toString() {
    ...
    sb.append("class AccidentTypeEnumG {\n");
