...
public class VehicleStatusEnumG {

  private VehicleStatusEnum value;

  private String extendedValueG;

  public VehicleStatusEnumG() {
    super();
  }
   ...
   */
  public VehicleStatusEnumG(VehicleStatusEnum value) {
    this.value = value;
  }

  public VehicleStatusEnumG value(VehicleStatusEnum value) {
    this.value = value;
    return this;
  }
  ...
  public VehicleStatusEnumG extendedValueG(String extendedValueG) {
  ...
  public boolean equals(Object o) {
    ...
    VehicleStatusEnumG vehicleStatusEnumG = (VehicleStatusEnumG) o;
    return Objects.equals(this.value, vehicleStatusEnumG.value) &&
        Objects.equals(this.extendedValueG, vehicleStatusEnumG.extendedValueG);
  }
  ...
  public String toString() {
    ...
    sb.append("class VehicleStatusEnumG {\n");
