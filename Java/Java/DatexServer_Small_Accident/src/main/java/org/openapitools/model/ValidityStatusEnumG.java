...
public class ValidityStatusEnumG {

  private ValidityStatusEnum value;

  private String extendedValueG;

  public ValidityStatusEnumG() {
    super();
  }
   ...
   */
  public ValidityStatusEnumG(ValidityStatusEnum value) {
    this.value = value;
  }

  public ValidityStatusEnumG value(ValidityStatusEnum value) {
    this.value = value;
    return this;
  }
  ...
  public ValidityStatusEnumG extendedValueG(String extendedValueG) {
  ...
  public boolean equals(Object o) {
    ...
    ValidityStatusEnumG validityStatusEnumG = (ValidityStatusEnumG) o;
    return Objects.equals(this.value, validityStatusEnumG.value) &&
        Objects.equals(this.extendedValueG, validityStatusEnumG.extendedValueG);
  }
  ...
  public String toString() {
    ...
    sb.append("class ValidityStatusEnumG {\n");
