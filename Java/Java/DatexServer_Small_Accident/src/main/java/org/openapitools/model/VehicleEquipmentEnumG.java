...
public class VehicleEquipmentEnumG {

  private VehicleEquipmentEnum value;

  private String extendedValueG;

  public VehicleEquipmentEnumG() {
    super();
  }
   ...
   */
  public VehicleEquipmentEnumG(VehicleEquipmentEnum value) {
    this.value = value;
  }

  public VehicleEquipmentEnumG value(VehicleEquipmentEnum value) {
    this.value = value;
    return this;
  }
  ...
  public VehicleEquipmentEnumG extendedValueG(String extendedValueG) {
  ...
  public boolean equals(Object o) {
    ...
    VehicleEquipmentEnumG vehicleEquipmentEnumG = (VehicleEquipmentEnumG) o;
    return Objects.equals(this.value, vehicleEquipmentEnumG.value) &&
        Objects.equals(this.extendedValueG, vehicleEquipmentEnumG.extendedValueG);
  }
  ...
  public String toString() {
    ...
    sb.append("class VehicleEquipmentEnumG {\n");
