...
public class InjuryStatusTypeEnumG {

  private InjuryStatusTypeEnum value;

  private String extendedValueG;

  public InjuryStatusTypeEnumG() {
    super();
  }
   ...
   */
  public InjuryStatusTypeEnumG(InjuryStatusTypeEnum value) {
    this.value = value;
  }

  public InjuryStatusTypeEnumG value(InjuryStatusTypeEnum value) {
    this.value = value;
    return this;
  }
  ...
  public InjuryStatusTypeEnumG extendedValueG(String extendedValueG) {
  ...
  public boolean equals(Object o) {
    ...
    InjuryStatusTypeEnumG injuryStatusTypeEnumG = (InjuryStatusTypeEnumG) o;
    return Objects.equals(this.value, injuryStatusTypeEnumG.value) &&
        Objects.equals(this.extendedValueG, injuryStatusTypeEnumG.extendedValueG);
  }
  ...
  public String toString() {
    ...
    sb.append("class InjuryStatusTypeEnumG {\n");
