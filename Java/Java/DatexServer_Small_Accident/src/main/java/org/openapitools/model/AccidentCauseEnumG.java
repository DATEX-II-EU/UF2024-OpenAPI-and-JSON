...
public class AccidentCauseEnumG {

  private AccidentCauseEnum value;

  private String extendedValueG;

  public AccidentCauseEnumG() {
    super();
  }
   ...
   */
  public AccidentCauseEnumG(AccidentCauseEnum value) {
    this.value = value;
  }

  public AccidentCauseEnumG value(AccidentCauseEnum value) {
    this.value = value;
    return this;
  }
  ...
  public AccidentCauseEnumG extendedValueG(String extendedValueG) {
  ...
  public boolean equals(Object o) {
    ...
    AccidentCauseEnumG accidentCauseEnumG = (AccidentCauseEnumG) o;
    return Objects.equals(this.value, accidentCauseEnumG.value) &&
        Objects.equals(this.extendedValueG, accidentCauseEnumG.extendedValueG);
  }
  ...
  public String toString() {
    ...
    sb.append("class AccidentCauseEnumG {\n");
