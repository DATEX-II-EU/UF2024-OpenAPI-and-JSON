...
public class PredefinedServiceEnumG {

  private PredefinedServiceEnum value;

  private String extendedValueG;

  public PredefinedServiceEnumG() {
    super();
  }
   ...
   */
  public PredefinedServiceEnumG(PredefinedServiceEnum value) {
    this.value = value;
  }

  public PredefinedServiceEnumG value(PredefinedServiceEnum value) {
    this.value = value;
    return this;
  }
  ...
  public PredefinedServiceEnumG extendedValueG(String extendedValueG) {
  ...
  public boolean equals(Object o) {
    ...
    PredefinedServiceEnumG predefinedServiceEnumG = (PredefinedServiceEnumG) o;
    return Objects.equals(this.value, predefinedServiceEnumG.value) &&
        Objects.equals(this.extendedValueG, predefinedServiceEnumG.extendedValueG);
  }
  ...
  public String toString() {
    ...
    sb.append("class PredefinedServiceEnumG {\n");
