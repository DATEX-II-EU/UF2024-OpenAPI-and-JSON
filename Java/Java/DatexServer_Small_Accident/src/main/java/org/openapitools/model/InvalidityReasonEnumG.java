...
public class InvalidityReasonEnumG {

  private InvalidityReasonEnum value;

  private String extendedValueG;

  public InvalidityReasonEnumG() {
    super();
  }
   ...
   */
  public InvalidityReasonEnumG(InvalidityReasonEnum value) {
    this.value = value;
  }

  public InvalidityReasonEnumG value(InvalidityReasonEnum value) {
    this.value = value;
    return this;
  }
  ...
  public InvalidityReasonEnumG extendedValueG(String extendedValueG) {
  ...
  public boolean equals(Object o) {
    ...
    InvalidityReasonEnumG invalidityReasonEnumG = (InvalidityReasonEnumG) o;
    return Objects.equals(this.value, invalidityReasonEnumG.value) &&
        Objects.equals(this.extendedValueG, invalidityReasonEnumG.extendedValueG);
  }
  ...
  public String toString() {
    ...
    sb.append("class InvalidityReasonEnumG {\n");
