...
public class InformationStatusEnumG {

  private InformationStatusEnum value;

  private String extendedValueG;

  public InformationStatusEnumG() {
    super();
  }
   ...
   */
  public InformationStatusEnumG(InformationStatusEnum value) {
    this.value = value;
  }

  public InformationStatusEnumG value(InformationStatusEnum value) {
    this.value = value;
    return this;
  }
  ...
  public InformationStatusEnumG extendedValueG(String extendedValueG) {
  ...
  public boolean equals(Object o) {
    ...
    InformationStatusEnumG informationStatusEnumG = (InformationStatusEnumG) o;
    return Objects.equals(this.value, informationStatusEnumG.value) &&
        Objects.equals(this.extendedValueG, informationStatusEnumG.extendedValueG);
  }
  ...
  public String toString() {
    ...
    sb.append("class InformationStatusEnumG {\n");
