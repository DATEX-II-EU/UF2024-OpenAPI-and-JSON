...
public class OperatingModeEnumG {

  private OperatingModeEnum value;

  private String extendedValueG;

  public OperatingModeEnumG() {
    super();
  }
   ...
   */
  public OperatingModeEnumG(OperatingModeEnum value) {
    this.value = value;
  }

  public OperatingModeEnumG value(OperatingModeEnum value) {
    this.value = value;
    return this;
  }
  ...
  public OperatingModeEnumG extendedValueG(String extendedValueG) {
  ...
  public boolean equals(Object o) {
    ...
    OperatingModeEnumG operatingModeEnumG = (OperatingModeEnumG) o;
    return Objects.equals(this.value, operatingModeEnumG.value) &&
        Objects.equals(this.extendedValueG, operatingModeEnumG.extendedValueG);
  }
  ...
  public String toString() {
    ...
    sb.append("class OperatingModeEnumG {\n");
