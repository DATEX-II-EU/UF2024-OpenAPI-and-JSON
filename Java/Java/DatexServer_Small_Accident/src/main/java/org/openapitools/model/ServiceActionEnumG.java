...
public class ServiceActionEnumG {

  private ServiceActionEnum value;

  private String extendedValueG;

  public ServiceActionEnumG() {
    super();
  }
   ...
   */
  public ServiceActionEnumG(ServiceActionEnum value) {
    this.value = value;
  }

  public ServiceActionEnumG value(ServiceActionEnum value) {
    this.value = value;
    return this;
  }
  ...
  public ServiceActionEnumG extendedValueG(String extendedValueG) {
  ...
  public boolean equals(Object o) {
    ...
    ServiceActionEnumG serviceActionEnumG = (ServiceActionEnumG) o;
    return Objects.equals(this.value, serviceActionEnumG.value) &&
        Objects.equals(this.extendedValueG, serviceActionEnumG.extendedValueG);
  }
  ...
  public String toString() {
    ...
    sb.append("class ServiceActionEnumG {\n");
