...
public class AltitudeAccuracyEnumG {

  private AltitudeAccuracyEnum value;

  private String extendedValueG;

  public AltitudeAccuracyEnumG() {
    super();
  }
   ...
   */
  public AltitudeAccuracyEnumG(AltitudeAccuracyEnum value) {
    this.value = value;
  }

  public AltitudeAccuracyEnumG value(AltitudeAccuracyEnum value) {
    this.value = value;
    return this;
  }
  ...
  public AltitudeAccuracyEnumG extendedValueG(String extendedValueG) {
  ...
  public boolean equals(Object o) {
    ...
    AltitudeAccuracyEnumG altitudeAccuracyEnumG = (AltitudeAccuracyEnumG) o;
    return Objects.equals(this.value, altitudeAccuracyEnumG.value) &&
        Objects.equals(this.extendedValueG, altitudeAccuracyEnumG.extendedValueG);
  }
  ...
  public String toString() {
    ...
    sb.append("class AltitudeAccuracyEnumG {\n");
