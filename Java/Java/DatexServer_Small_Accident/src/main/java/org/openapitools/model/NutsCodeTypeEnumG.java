...
public class NutsCodeTypeEnumG {

  private NutsCodeTypeEnum value;

  private String extendedValueG;

  public NutsCodeTypeEnumG() {
    super();
  }
   ...
   */
  public NutsCodeTypeEnumG(NutsCodeTypeEnum value) {
    this.value = value;
  }

  public NutsCodeTypeEnumG value(NutsCodeTypeEnum value) {
    this.value = value;
    return this;
  }
  ...
  public NutsCodeTypeEnumG extendedValueG(String extendedValueG) {
  ...
  public boolean equals(Object o) {
    ...
    NutsCodeTypeEnumG nutsCodeTypeEnumG = (NutsCodeTypeEnumG) o;
    return Objects.equals(this.value, nutsCodeTypeEnumG.value) &&
        Objects.equals(this.extendedValueG, nutsCodeTypeEnumG.extendedValueG);
  }
  ...
  public String toString() {
    ...
    sb.append("class NutsCodeTypeEnumG {\n");
