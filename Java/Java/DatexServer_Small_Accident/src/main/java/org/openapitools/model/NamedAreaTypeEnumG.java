...
public class NamedAreaTypeEnumG {

  private NamedAreaTypeEnum value;

  private String extendedValueG;

  public NamedAreaTypeEnumG() {
    super();
  }
   ...
   */
  public NamedAreaTypeEnumG(NamedAreaTypeEnum value) {
    this.value = value;
  }

  public NamedAreaTypeEnumG value(NamedAreaTypeEnum value) {
    this.value = value;
    return this;
  }
  ...
  public NamedAreaTypeEnumG extendedValueG(String extendedValueG) {
  ...
  public boolean equals(Object o) {
    ...
    NamedAreaTypeEnumG namedAreaTypeEnumG = (NamedAreaTypeEnumG) o;
    return Objects.equals(this.value, namedAreaTypeEnumG.value) &&
        Objects.equals(this.extendedValueG, namedAreaTypeEnumG.extendedValueG);
  }
  ...
  public String toString() {
    ...
    sb.append("class NamedAreaTypeEnumG {\n");
