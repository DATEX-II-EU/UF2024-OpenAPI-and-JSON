...
public class ExchangeInformation {
   ...
   */
  public ExchangeInformation(ExchangeContext exchangeContext, DynamicInformation dynamicInformation) {
    this.exchangeContext = exchangeContext;
    this.dynamicInformation = dynamicInformation;
  }

  public ExchangeInformation messageType(MessageTypeEnumG messageType) {
  ...
  public ExchangeInformation exchangeContext(ExchangeContext exchangeContext) {
    this.exchangeContext = exchangeContext;
    return this;
  }
  ...
  public ExchangeInformation dynamicInformation(DynamicInformation dynamicInformation) {
    this.dynamicInformation = dynamicInformation;
    return this;
  }
  ...
  public ExchangeInformation exchangeInformationExtensionG(Map<String, Object> exchangeInformationExtensionG) {
    this.exchangeInformationExtensionG = exchangeInformationExtensionG;
    return this;
  }

  public ExchangeInformation putExchangeInformationExtensionGItem(String key, Object exchangeInformationExtensionGItem) {
  ...
  public boolean equals(Object o) {
    ...
    ExchangeInformation exchangeInformation = (ExchangeInformation) o;
    return Objects.equals(this.messageType, exchangeInformation.messageType) &&
        Objects.equals(this.exchangeContext, exchangeInformation.exchangeContext) &&
        Objects.equals(this.dynamicInformation, exchangeInformation.dynamicInformation) &&
        Objects.equals(this.exchangeInformationExtensionG, exchangeInformation.exchangeInformationExtensionG);
  }
